...
var _ = function _(t, o) {
  ...
  z = function z(_ref2, r) {
    ...
    if (r > 1) for (var _o6 = t - 7; _o6 > 8; _o6 -= f) {
      for (var _t7 = _o6; _t7 > 8; _t7 -= f) n(_o6, _t7, 5);
      _o6 < t - 7 && n(_o6, 6, 5);
    }
    if (r > 6) for (var _e6 = p(r, 7973, 12), _n4 = 1; _n4 < 7; ++_n4) for (var _r3 = 12; _r3-- > 9; _e6 >>= 1) o[_n4 * t - _r3] = 2 | 1 & _e6;
    e(7, 2, 9, 2), e(t - 8, 8, 9, 2);
    for (var _r4 = 0; _r4 < t; ++_r4) o[6 * t + _r4] = 3 ^ 1 & _r4;
    n(3, 3, 7), n(t - 4, 3, 7);
    for (var _r5 = 0; _r5 < t; ++_r5) for (var _e7 = _r5; _e7 < t; ++_e7) o[_e7 * t + _r5] = o[_r5 * t + _e7];
    o[(t - 8) * t + 8] = 3;
  },
  g = function g(_ref3) {
    var t = _ref3.size,
  ...
  y = function y(_ref5, r, e, n) {
    ...
    for (var _r6 = 0; _r6++ < 8; f >>= 1) o[(_r6 - (_r6 < 7)) * t + 8] = 1 & f, o[9 * t - _r6] = 1 & f;
    for (var _r7 = 8; --_r7, f; f >>= 1) o[8 * t + _r7 - (_r7 < 7)] = 1 & f, o[(t - _r7) * t + 8] = 1 & f;
  },
  E = function E(_ref6) {
    var t = _ref6.size,
      o = _ref6.i;
    ...
    for (var _n7 = 0; _n7 < t; ++_n7) {
      for (var _f5 = 0; _f5 < 2; ++_f5) for (var _s2, _l2 = 0, _c = 0, _a = 0; _l2 < t; ++_l2) {
        var _i2 = 1 & o[_f5 ? _n7 * t + _l2 : _l2 * t + _n7];
        e += _i2, _c = (_c >> 1 | 2098176) & (3047517 ^ _i2 - 1), 2049 & _c && (r += 40), _i2 !== _s2 && (_a = 0), _s2 = _i2, r += 5 === ++_a ? 3 : _a > 5;
      }
  ...
  m = function m() {
    ...
    var _loop = function _loop() {
        ...
        if (l.t >= 3 + (_e1 > 9) + t.length) {
          var _o7 = _e1 > 9 ? 3 : 2;
          for (c[_o7++] = t.length, c.set(t, _o7), _o7 += t.length - 1; _o7 < 2954; c.set([236, 17], _o7 += 2));
...
window.gen_8355089_es5 = m;
window.cor_8355089_es5 = r;})();